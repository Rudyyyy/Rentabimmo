...
export function calculateSCITaxResults(
  ...
  properties.forEach(property => {
    ...
    const propertyExpenses = 
      ...
      Number(yearExpense.interest || 0) -
      Number(yearExpense.tenantCharges || 0); // Les charges locataires sont soustraites
